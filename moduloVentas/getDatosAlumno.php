                ...
                if($tipoAccion == "registro"){
                   // inserta
                    ...
                    if($response != 1){
                        ...
                        include_once('../compartido/screenMensajeSistema.php');
                        $objMensaje = new screenMensajeSistema();
                        $objMensaje -> screenMensajeSistemaShow("Ocurrio un error al crear al nuevo empleado",'');
                        return;
                    }
                }else{
                    //update
                    ...
                    if($response != 1){
                        ...
                        include_once('../compartido/screenMensajeSistema.php');
                        $objMensaje = new screenMensajeSistema();
                        $objMensaje -> screenMensajeSistemaShow("Ocurrio un error al actualizar el empleado",'');
                        return;
                    }
                }

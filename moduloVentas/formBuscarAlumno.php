<?                
    ...
    {
        public function formBuscarAlumnoShow($horario,$id,$nivel)
        {
                ...
                <form action="./getDatosAlumno.php" method="POST">
                    <div class="welcome-message" style="margin-top: 70px">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="inputNombre" name="inputHorario" placeholder="" value="'.$horario.'" disabled>
                        </div>

                        <div class="mb-3">
                            <label for="inputNivel" class="form-label">Nivel Elegido</label>
                            <input type="text" class="form-control" id="inputNivel" name="nivel" placeholder="" value="'.$nivel.'" disabled>
                        </div>

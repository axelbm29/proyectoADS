...
class panelPrincipalShow extends formulario
{
    public function panelShow($body, $link = "")
    {
        ...
        <div class="container position-relative" style="left: -140px;">
            <div class="sidebar">
                <img style="margin-left: 25px" src="../assets/images/logo.png" alt="Logo" />
                ...
                <ul>
                    ...
                    for ($i = 0; $i < $cantidadPrivilegios; $i++) {
                        ...
                        <form id="formRegistrarPago" action="<?php echo $listaPrivilegios[$i]['pathPrivilegio']; ?>" method="POST">
                            <li>
                                <button type="submit" class="link-button active"
                                    name="<? echo $listaPrivilegios[$i]['labelPrivilegio'] ?>">
                                    <i class="fas fa-money-bill"></i>
                                    <?php echo $listaPrivilegios[$i]['labelPrivilegio']; ?>
                                </button>
                            </li>
                        </form>
